    ...
    render() {
        return(
            <tr key={this.props.game.id}>
                ...
                <td><img src={require(`./badges/${this.props.game.home_team}.png`)} height={'30'} width={'30'} alt='team badge'/> <Link to={`/team/${this.props.game.home_team}`}>{this.props.game.home_team}</Link>{this.props.showLeaguePosition && <span> {this.props.homeLeaguePosition}th</span>}</td>}
                {this.props.showAllColumns && 
                <td><img src={require(`./badges/${this.props.game.away_team}.png`)} height={'30'} width={'30'} alt='team badge'/> <Link to={`/team/${this.props.game.away_team}`}>{this.props.game.away_team}</Link>{this.props.showLeaguePosition && <span> {this.props.awayLeaguePosition}th</span>}</td>}
